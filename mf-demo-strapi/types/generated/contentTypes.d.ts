...
export interface PluginMfBuilderMfSource extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    pluralName: 'mf-sources';
    singularName: 'mf-source';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    lastFetched: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    remoteEntry: Schema.Attribute.String;
...
export interface PluginMfBuilderPageLayout extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    pluralName: 'page-layouts';
    singularName: 'page-layout';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    gridConfig: Schema.Attribute.JSON;
